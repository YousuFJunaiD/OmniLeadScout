...
import EnterpriseIntelligencePage from "./pages/EnterpriseIntelligencePage"
  ...
  return (
    <Router>
      <Routes>
        ...
        <Route path="/enterprise" element={protectedArea(<EnterpriseIntelligencePage user={user} onLogout={logout} />)} />
